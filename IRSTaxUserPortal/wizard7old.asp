...
<body>
  <div class="brand-hero">
    <map name="FPMap0">
    <area href="expand7.asp" shape="rect" coords="354, 132, 619, 171">
    <area href="CC.asp" shape="rect" coords="648, 132, 808, 172">
    <area href="" shape="rect" coords="844, 134, 1215, 170">
    <area href="/Login.aspx" shape="rect" coords="1284, 132, 1551, 173">
    <area href="https://www.irstaxrecords.com" shape="rect" coords="360, 13, 582, 124"></map><img src="https://www.irstaxrecords.com/new/images/top2.jpg" alt="IRS Tax Records" width="1902" height="190" usemap="#FPMap0" />
  </div>
